...
//    }
        ...
        double megaMultPerSecond = (double) NUM_ELEMENTS / (time1 - time0) / 1000000000.;

        if (megaMultPerSecond > maxMegaMultPerSecond)
            maxMegaMultPerSecond = megaMultPerSecond;
    ...
    printf("%10d;    %8d;    %4d;    %10.3lf\n",
           NUM_WORK_GROUPS, NUM_ELEMENTS, LOCAL_SIZE, maxMegaMultPerSecond);
