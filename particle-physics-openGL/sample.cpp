...
const char *WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Linge Ge" };
...
const int NUM_PARTICLES = 1024*1024*1;
const int LOCAL_SIZE    = 32;
const char *CL_FILE_NAME   = { "gel.cl" };
...
InitCL( )
{
	...
	if( fp == NULL )
	{
		...
		fprintf(stdout, "Opened OpenCL source file '%s'\n", CL_FILE_NAME);
	}
